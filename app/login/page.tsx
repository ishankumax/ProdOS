          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group/pass">
              <input
                ...
                placeholder="••••••••"
                className="w-full rounded-lg border border-white/10 bg-white/5 pl-3.5 pr-11 py-2.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 transition-all font-sans"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-0 top-0 h-full w-10 flex items-center justify-center text-brand-400/50 hover:text-brand-300 transition-colors focus:outline-none z-20"
