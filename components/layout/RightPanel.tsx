...
export default function RightPanel() {
  ...
  return (
    <aside className="w-64 border-l border-white/5 h-full p-6 bg-[#0d0d14] flex flex-col overflow-y-auto">
      {/* ── Clock ──────────────────────────────────── */}
      <div className="mb-8">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="font-mono">
              {new Date(time.getTime() - 12.5 * 60 * 60 * 1000).toLocaleTimeString([], {
                hour: "2-digit",
                minute: "2-digit",
              })}
            </span>
          ...
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="font-mono">
              {new Date(time.getTime() - 4.5 * 60 * 60 * 1000).toLocaleTimeString([], {
                hour: "2-digit",
                minute: "2-digit",
              })}
            </span>
